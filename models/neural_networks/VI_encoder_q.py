...
class VariationalAutoencoder(object):
    ...
    def __init__(self, name, n_input1=3, n_input2=256, n_output=4, n_channels=3, n_modes=2, n_weights=2048, drate=0.2, n_filters=8, filter_size=8, maxpool=4, strides=1, dilations=1, batch_norm=True,twod_conv=False):
